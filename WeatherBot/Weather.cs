...
namespace WeatherBot
{
    public class Weather
    {
        ...
        public static async Task<WeatherAPIModelNew> GetWeatherDetails(string location)
        {
            LocationAPIModel multipleLocations = new LocationAPIModel();
            WeatherAPIModelNew weatherAPIModelNew = new WeatherAPIModelNew();
            ...
            { 
                ...
                string weatherURL = weatherURI.Replace("xxxx", location);
                ...
                using (HttpClient httpClient = new HttpClient(handler))
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        weatherAPIModelNew = JsonConvert.DeserializeObject<WeatherAPIModelNew>(weatherDetails);
                        return weatherAPIModelNew;
                    }
                    else
                        return null;
                }                
